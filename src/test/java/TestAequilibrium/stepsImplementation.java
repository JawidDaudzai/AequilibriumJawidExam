...
public class stepsImplementation extends BaseClass {
	...
	public void user_sees_text_of_invalid_user(String expectedInvalidUserText) {
		...
		Assert.assertEquals("Invalid user text was Not displayed correctly ", expectedInvalidUserText,
				actualInvalidUserText);
	...
	public void user_sees_text_of_invalid_password(String expectedPasswordText) {
		...
		Assert.assertEquals("Invalid password text was Not displayed correctly ", expectedPasswordText,
				actualPasswordText);
	}
